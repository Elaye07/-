...
void DrawTEXT(int y)
    ...
    txDrawText (0, y, 800, y+100, "Мультик про деревню");
    txDrawText (0, y, 800, y+150, "КОНЕЦ");
    txDrawText (0, y, 800, y+200, "НУ- это, да");
    txDrawText (0, y, 800, y+250, "ЭэЭЭэЭэ");
...
void DrawText(int y)
    ...
    txSelectFont ("Comic Sans MS", 40);
    txDrawText (0, y, 800, y+100, "Мультик про деревню");
    txDrawText (0, y, 800, y+150, "АоЭэааоаАэ");
    txDrawText (0, y, 800, y+200, "Ураф");
    txDrawText (0, y, 800, y+250, "АоЭэааоаАэ");
...
int main()
    ...
    while(xSun<1000)
    {
      ...
      if(BAZAR<1000)
    {
const char* name = txInputBox ("Чудесная сегодня погода, не так ли?", "System", "Да, сер!");
txMessageBox ("Полностью с тобой согласен!");
BAZAR += 1000;
